...
void Demo::Render() {
	...
	glEnable(GL_CULL_FACE); //backface culling untuk menghapus permukaan belakang yang tidak nampak ke kamera untuk optimasi
...
void Demo::BuildColoredKakiMeja() {
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
...
int main(int argc, char** argv) {
	...
	app.Start("Tugas 1: Primitive & Texture Mapping", 800, 600, false, false);
}
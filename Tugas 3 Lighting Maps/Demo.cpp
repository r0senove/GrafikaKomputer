...
void Demo::BuildColoredCube() {
	...
	float vertices[] = {
		...
		// front
		-0.5, 0.2, 0.5,  0.0f,  0.0f,  1.0f, // 0
		0.9, 0.2, 0.5,   0.0f,  0.0f,  1.0f, // 1
		0.9, 0.5, 0.5,   0.0f,  0.0f,  1.0f, // 2
		-0.5, 0.5, 0.5,  0.0f,  0.0f,  1.0f, // 3

		// right
		0.9,  0.5,  0.5, 1.0f,  0.0f,  0.0f, // 4
		0.9,  0.5, -0.5, 1.0f,  0.0f,  0.0f, // 5
		0.9,  0.2, -0.5, 1.0f,  0.0f,  0.0f, // 6
		0.9,  0.2,  0.5, 1.0f,  0.0f,  0.0f, // 7

		// back
		-0.5,  0.2, -0.5, 0.0f,  0.0f,  -1.0f, // 8 
		0.9,   0.2, -0.5, 0.0f,  0.0f,  -1.0f, // 9
		0.9,   0.5, -0.5, 0.0f,  0.0f,  -1.0f, // 10
		-0.5,  0.5, -0.5, 0.0f,  0.0f,  -1.0f, // 11

		// left
		-0.5,  0.2, -0.5, -1.0f,  0.0f,  0.0f, // 12
		-0.5,  0.2,  0.5, -1.0f,  0.0f,  0.0f, // 13
		-0.5,  0.5,  0.5, -1.0f,  0.0f,  0.0f, // 14
		-0.5,  0.5, -0.5, -1.0f,  0.0f,  0.0f, // 15

		// upper
		0.9, 0.5,  0.5,  0.0f,  1.0f,  0.0f, // 16
		-0.5, 0.5,  0.5, 0.0f,  1.0f,  0.0f, // 17
		-0.5, 0.5, -0.5, 0.0f,  1.0f,  0.0f, // 18
		0.9, 0.5, -0.5,  0.0f,  1.0f,  0.0f, // 19

		// bottom
		-0.5, 0.2, -0.5, 0.0f,  -1.0f,  0.0f, // 20
		0.9,  0.2, -0.5,  0.0f,  -1.0f,  0.0f, // 21
		0.9,  0.2,  0.5,  0.0f,  -1.0f,  0.0f, // 22
		-0.5, 0.2,  0.5, 0.0f,  -1.0f,  0.0f, // 23
	};
...
void Demo::BuildColoredCube2() {
	...
	float vertices[] = {
		// format position, tex coords
		// front
		-0.1, -0.5, 0.3,  0.0f,  0.0f,  1.0f, // 0
		0.5, -0.5, 0.3,   0.0f,  0.0f,  1.0f, // 1
		0.5,  0.2, 0.3,   0.0f,  0.0f,  1.0f, // 2
		-0.1,  0.2, 0.3,  0.0f,  0.0f,  1.0f, // 3

		// right
		0.5,  0.2,  0.3, 1.0f,  0.0f,  0.0f, // 4
		0.5,  0.2, -0.3, 1.0f,  0.0f,  0.0f, // 5
		0.5, -0.5, -0.3, 1.0f,  0.0f,  0.0f, // 6
		0.5, -0.5,  0.3, 1.0f,  0.0f,  0.0f, // 7

		// back
		-0.1, -0.5, -0.3, 0.0f,  0.0f,  -1.0f, // 8 
		0.5,  -0.5, -0.3, 0.0f,  0.0f,  -1.0f, // 9
		0.5,   0.2, -0.3, 0.0f,  0.0f,  -1.0f, // 10
		-0.1,  0.2, -0.3, 0.0f,  0.0f,  -1.0f, // 11

		// left
		-0.1, -0.5, -0.3, -1.0f,  0.0f,  0.0f, // 12
		-0.1, -0.5,  0.3, -1.0f,  0.0f,  0.0f, // 13
		-0.1,  0.2,  0.3, -1.0f,  0.0f,  0.0f, // 14
		-0.1,  0.2, -0.3, -1.0f,  0.0f,  0.0f, // 15

		// upper
		0.5, 0.2,  0.3,  0.0f,  1.0f,  0.0f, // 16
		-0.1, 0.2,  0.3, 0.0f,  1.0f,  0.0f, // 17
		-0.1, 0.2, -0.3, 0.0f,  1.0f,  0.0f, // 18
		0.5, 0.2, -0.3,  0.0f,  1.0f,  0.0f, // 19

		// bottom
		-0.1, -0.49, -0.3, 0.0f,  -1.0f,  0.0f, // 20
		0.5, -0.49, -0.3,  0.0f,  -1.0f,  0.0f, // 21
		0.5, -0.49,  0.3,  0.0f,  -1.0f,  0.0f, // 22
		-0.1, -0.49,  0.3, 0.0f,  -1.0f,  0.0f, // 23
	};
...
void Demo::DrawColoredPlane()
{
	...
	// set lighting materials attributes (red plastic)
	GLint ambientMatLoc = glGetUniformLocation(this->activeProgram, "material.ambient");
	glUniform3f(ambientMatLoc, 0.0f, 0.0f, 0.0f);
	GLint diffuseMatLoc = glGetUniformLocation(this->activeProgram, "material.diffuse");
	glUniform3f(diffuseMatLoc, 0.5f, 0.0f, 0.0f);
	GLint specularMatLoc = glGetUniformLocation(this->activeProgram, "material.specular");
	glUniform3f(specularMatLoc, 0.70f, 0.60f, 0.60f);
	GLint shininessMatLoc = glGetUniformLocation(this->activeProgram, "material.shininess");
	glUniform1f(shininessMatLoc, 0.25f);
...
void Demo::DrawTexturedCube2()
{
	...
	glBindTexture(GL_TEXTURE_2D, cube_texture2);
	glUniform1i(glGetUniformLocation(this->activeProgram, "material.diffuse"), 4);

	glActiveTexture(GL_TEXTURE5);
	glBindTexture(GL_TEXTURE_2D, stexture3);
	glUniform1i(glGetUniformLocation(this->activeProgram, "material.specular"), 5);
...
int main(int argc, char** argv) {
	...
	app.Start("Tugas 3 Lighting Maps: Press [SPACE] to toggle textured cube", 800, 600, false, false);
}